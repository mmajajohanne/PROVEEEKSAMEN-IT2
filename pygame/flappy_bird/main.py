#MÅ GJØRE DENNE TIL OOP
#FORELØPIG BARE FUNKJSONER OG IKKE OBJEKTER/KLASSER/METODER
import time
...
def main():
    ...
    while not game_over:
        ...
        # Legger til vanskelighetsgrad relativ til scoren
        # Øker farten til blokkene og reduserer mellomrommet mellom blokkene
        ...
        # blokker på skjermen eller ikke
        if x_block < (-1 * block_width):
            x_block = surfaceWidth
            block_height = random.randint(0, surfaceHeight / 2)

        # kollisjon
        # sjekker om man er forbi blokken i X
